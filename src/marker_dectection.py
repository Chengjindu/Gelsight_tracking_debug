...
def init_HSR(img):
    ...
    # The focal length is represented by the first and second elements on the diagonal,
    # The optical centers are the third elements in the first and second rows
    # These parameters are specific to the camera's lens and sensor setup
